    ...
    const fetchFeaturedArtists = async () => {
      try {
        ...
        const uniqueArtistIds = [
          ...new Set(allSongs.map((song) => song.artistId)),
        ];
          ...
          {featuredArtists.length > 0 ? (
            featuredArtists.map((artist, index) => (
              <Link
                ...
                className="tunila-featured-artist-card"
              >
                <span className="tunila-artist-number">{index + 1}.</span>{" "}
                {/* ✅ Numbering */}
                ...
                <div className="tunila-featured-artist-info">
                  ...
                  <div className="tunila-featured-artist-verified">
                    <img
                      src={assets.verified_icon_black}
                      alt="Verified Badge"
                      className="tunila-verified-badge"
                    />
